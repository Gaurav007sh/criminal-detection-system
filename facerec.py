...
size = 2
haar_cascade = cv2.CascadeClassifier(r'C:\Users\gaura\PycharmProjects\Facial-Recognition-for-Crime-Detection-master\face_cascade.xml')

# Part 1: Create fisherRecognizer
def train_model():
    model = cv2.face.LBPHFaceRecognizer_create()
    fn_dir = r'C:\Users\gaura\PycharmProjects\Facial-Recognition-for-Crime-Detection-master\face_samples'
