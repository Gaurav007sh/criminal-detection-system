...
def basicPageSetup(pageNo):
    ...
    back_img = tk.PhotoImage(file= r"C:\Users\gaura\PycharmProjects\Facial-Recognition-for-Crime-Detection-master\img\back.png")
...
def selectMultiImage(opt_menu, menu_var):
    ...
    if(len(path_list) < 5):
        ...
        back_img = tk.PhotoImage(file=r'C:\Users\gaura\PycharmProjects\Facial-Recognition-for-Crime-Detection-master\img\previous.png')
        next_img = tk.PhotoImage(file=r'C:\Users\gaura\PycharmProjects\Facial-Recognition-for-Crime-Detection-master\img\front.png')

        prev_slide = tk.Button(slide_control_panel, image=back_img, bg="#202d42", highlightthickness=0,
...
def register(entries, required, menu_var):
    ...
    # Setting Directory
    path = os.path.join(r'C:\Users\gaura\PycharmProjects\Facial-Recognition-for-Crime-Detection-master\face_samples', r"C:\Users\gaura\PycharmProjects\Facial-Recognition-for-Crime-Detection-master\face_samples\temp_criminal")
...
def showCriminalProfile(name):
    ...
    # path3 = os.path.join(path2,"profile_pics")
    path = os.path.join(r"C:\Users\gaura\PycharmProjects\Facial-Recognition-for-Crime-Detection-master\profile_pics", "criminal %d.png"%id)
...
######################################## Home Page ####################################
tk.Label(pages[0], text="Face Recognition System for Criminal Detection", fg="white", bg="#3E3B3C",
      font="Arial 25 bold", pady=30).pack()

logo = tk.PhotoImage(file = r"C:\Users\gaura\PycharmProjects\Facial-Recognition-for-Crime-Detection-master\img\logo2.png")
